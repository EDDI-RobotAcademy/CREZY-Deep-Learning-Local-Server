...
class BERTSentenceTransform:
    ...
    def __call__(self, line):
        ...
        print(f"text_a[0]: {text_a[0]}")
        tokens_a = self._tokenizer.tokenize(text_a[0])
        tokens_b = None
...
print("emotion script_directory: ", script_directory)
absolute_module_path = os.path.abspath(os.path.join(script_directory, '../../data/model.pt'))
...
model.load_state_dict(torch.load(
    os.path.join(script_directory, '../../data/model.pt'), map_location=device))


def sentiment_analysis(data):
    sentence = [data, '0']
    dataset_another = [sentence]
